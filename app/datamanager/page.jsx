...
const DataMagang = () => {
  ...
  return (
    <div className="bg-white dark:bg-slate-900 dark:text-white rounded-lg mx-4 p-4 text-xl sm:block ">
                ...
                <tr key={user.uuid} className="bg-white dark:bg-gray-800">
                  ...
                  <td className="px-6 py-4">
                    ...
                    <button
                      ...
                      className="flex items-center hover:bg-red-200 hover:text-gray-800 rounded-xl p-2 w-full"
                    >
      ...
      <div className="bg-white flex flex-col rounded-lg mx-2 p-3 text-xl dark:bg-slate-900 sm:hidden">
        <div className="flex gap-4">
          ...
          <p className="py-6 font-semibold">DATA MANAGER</p>
